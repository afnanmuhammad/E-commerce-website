...
import img1 from "../assets/images/124.png";

const Testimonials = () => {
  const rating = 4.8; // Average rating out of 5
  const reviews = [
    {
      name: "Shazia Saiiad",
      image:
      ...
      content:
        "The shirt is excellent in terms of both design and fabric. We will definitely be buying more.",
    },
    {
      name: "Haneeah",
      image: img1,
      ...
      title: "",
      content:
        "the quality of their burgundy skirt is SUPERB, it's not see through at all, neat stitching and the sizing is even better, perfection ! ❤️",
    },
    {
      name: "Hamzah Waseem",
      image:
        "https://images.unsplash.com/photo-1617137984095-74e4e5e3613f?w=400&auto=format&fit=crop",
      stars: 5,
      title: "Zipe Sweatshirt-Brown Reivew",
      content:
        "The Product was good and size also, I'm 6ft tall, so the length of product is really matter to me, so amazingly all the measurements came into fit position.",
    },
  ];
          ...
          <div className="flex items-center gap-1 mb-2">
            {[...Array(5)].map((_, i) => (
              <svg
                ...
                height="20"
                viewBox="0 0 24 24"
                fill={i < Math.round(rating) ? "#facc15" : "#e5e7eb"} // yellow / gray
              >
