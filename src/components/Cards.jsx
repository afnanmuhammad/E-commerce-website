...
const Cards = ({ id, image, title, price, oldPrice, discount, colors, className }) => {
  ...
  return (
    <div className="flex flex-col items-center group cursor-pointer w-full  font-['Montserrat'] shadow-sm hover:shadow-lg transition-shadow bg-white p-4">
      <div className="relative overflow-hidden w-full md:h-60 lg:h-50 sm:h-64">
        {discount && (
