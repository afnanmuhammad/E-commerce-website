  ...
  return (
    <div className="w-full  bg-[#fdfdfd] min-h-screen font-['Montserrat']">
      ...
      <div className="max-w-[1600px] mx-auto px-4 md:px-12 py-10">
        <h1 className="text-center text-[24px] font-normal tracking-widest mb-12 uppercase text-[#1a1a1a]">
          Your Cart
        </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="flex-1">
              ...
              {cartItems.length === 0 ? (
                ...
                cartItems.map((item) => (
                  <div
                    ...
                    className="py-6 border-b border-gray-100 flex flex-col md:grid md:grid-cols-[3fr_1fr_1fr_1fr] items-center gap-6"
                  >
                    {/* Product Info */}
                    <div className="flex items-center gap-6 w-full">
                      <button
                        ...
                        className="w-6 h-6 rounded-full bg-black text-white flex items-center justify-center flex-shrink-0 hover:opacity-70 transition-opacity"
                      >
                        <MdClose size={14} />
                      </button>
                      ...
                      <div className="flex flex-col">
                        <h3 className="text-[14px] text-[#333] font-normal leading-relaxed mb-1">
                          {item.title}
                        </h3>
                    ...
                    {/* Price Desktop */}
                    <div className="hidden md:block text-[14px] text-[#333]">
                      {item.price}
                    </div>
                    ...
                    <div className="flex md:hidden justify-between w-full items-center">
                      ...
                      <div className="flex items-center border border-gray-200">
                        ...
                        <span className="px-3 py-2 text-[13px] min-w-[30px] text-center">
                          {item.quantity}
                        </span>
                        <button
                          onClick={() =>
                    ...
                    {/* Total Desktop */}
                    <div className="hidden md:block text-right text-[14px] text-[#333]">
                      {formatPrice(parsePrice(item.price) * item.quantity)}
                    </div>
                  </div>
                ))
            ...
            <div className="flex justify-between items-center mt-8">
              <Link
                to="/"
                className="text-[12px] font-bold tracking-widest uppercase text-[#333] hover:underline"
              >
                &lt; Continue Shopping
              </Link>
            </div>
          ...
          <div className="w-full lg:w-[400px] bg-[#f9f9f9] p-8 h-fit">
            <h2 className="text-[13px] font-bold tracking-widest uppercase mb-6 text-[#1a1a1a]">
              Get Shipping Estimates
            </h2>

            <div className="space-y-4 mb-2">
              <div>
                <label className="block text-[13px] text-[#666] mb-2">
                  Country
                </label>
              ...
              <div>
                ...
                <input
                  type="text"
                  className="w-full p-2.5 border border-gray-200 bg-white rounded-sm focus:outline-none focus:border-black"
                />
              </div>
            ...
            <div className="border-t border-gray-200 pt-6 space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-[13px] font-bold tracking-widest uppercase text-[#1a1a1a]">
                  Subtotal
                </span>
              ...
              <Link
                to="/checkout"
                className="block w-full bg-black text-white py-4 text-[12px] font-bold tracking-[0.15em] hover:opacity-80 transition-opacity uppercase shadow-md text-center"
              >
                Proceed to Checkout
              </Link>
      ...
      <div className="fixed bottom-8 left-8 z-50">
        <a
          href="#"
          className="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform cursor-pointer"
        >
